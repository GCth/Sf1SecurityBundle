...
namespace Dsnet\Sf1SecurityBundle\Session\Handler;

/**
 * PdoSessionHandler.
 *
 * GCth - disabled base64 encoding/deconding while writing to database
 * this allows compatibility with symfony 1.4
 * cannot inherit from original handler, since some properties are private
 *
